...
/* Pin definitions */
#define HD44780_RS_LOW HAL_GPIO_WritePin(LCD_RS_GPIO_Port, LCD_RS_Pin, GPIO_PIN_RESET)
#define HD44780_RS_HIGH HAL_GPIO_WritePin(LCD_RS_GPIO_Port, LCD_RS_Pin, GPIO_PIN_SET)
#define HD44780_E_LOW HAL_GPIO_WritePin(LCD_EN_GPIO_Port, LCD_EN_Pin, GPIO_PIN_RESET)
#define HD44780_E_HIGH HAL_GPIO_WritePin(LCD_EN_GPIO_Port, LCD_EN_Pin, GPIO_PIN_SET)

#define HD44780_E_BLINK                                                                                                                    \
    HD44780_E_HIGH;                                                                                                                        \
    HD44780_Delay(20);                                                                                                                     \
    HD44780_E_LOW;                                                                                                                         \
    HD44780_Delay(20)
#define HD44780_Delay(x) TM_HD44780_Delay(x)
...
static inline void TM_HD44780_Delay(__IO uint32_t micros) {
    /* Go to clock cycles */
...
static void TM_HD44780_Cmd4bit(uint8_t cmd) {
    /* Set output port */
    HAL_GPIO_WritePin(LCD_D7_GPIO_Port, LCD_D7_Pin, (cmd & 0x08));
    HAL_GPIO_WritePin(LCD_D6_GPIO_Port, LCD_D6_Pin, (cmd & 0x04));
    HAL_GPIO_WritePin(LCD_D5_GPIO_Port, LCD_D5_Pin, (cmd & 0x02));
...
static void TM_HD44780_InitPins(void) {
    /* Init all pins */
    //	TM_GPIO_Init(LCD_RS_GPIO_Port, LCD_RS_Pin, TM_GPIO_Mode_OUT, TM_GPIO_OType_PP, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_Low);
    //	TM_GPIO_Init(LCD_EN_GPIO_Port, LCD_EN_Pin, TM_GPIO_Mode_OUT, TM_GPIO_OType_PP, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_Low);
    //	TM_GPIO_Init(LCD_D4_GPIO_Port, LCD_D4_Pin, TM_GPIO_Mode_OUT, TM_GPIO_OType_PP, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_Low);
    //	TM_GPIO_Init(LCD_D5_GPIO_Port, LCD_D5_Pin, TM_GPIO_Mode_OUT, TM_GPIO_OType_PP, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_Low);
    //	TM_GPIO_Init(LCD_D6_GPIO_Port, LCD_D6_Pin, TM_GPIO_Mode_OUT, TM_GPIO_OType_PP, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_Low);
    //	TM_GPIO_Init(LCD_D7_GPIO_Port, LCD_D7_Pin, TM_GPIO_Mode_OUT, TM_GPIO_OType_PP, TM_GPIO_PuPd_NOPULL, TM_GPIO_Speed_Low);
