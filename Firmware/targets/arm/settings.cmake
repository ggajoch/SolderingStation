...
set(RANDOM_DEFS "-D\"__weak=__attribute__((weak))\" -D\"__packed=__attribute__((__packed__))\" -DUSE_HAL_DRIVER -DSTM32F103xB ")

set(CMAKE_C_FLAGS "-std=gnu11 -Os ${CWARN} ${CTUNING} ${CMCU} ${RANDOM_DEFS} -g")
set(CMAKE_CXX_FLAGS "-std=gnu++1z -Os -fno-exceptions -fno-rtti ${CXXWARN} ${CTUNING} ${CMCU} ${RANDOM_DEFS} -g")
