...
class ConnectionManager(object):
    ...
    def parse_config(self, string):
            ...
            self.main.ui.maxTemperatureSpinBox.setValue(float(arr[8]))
            self.main.ui.brightnessSpinBox.setValue(float(arr[9]))
            self.main.ui.contrastSpinBox.setValue(float(arr[10]))
            self.main.ui.sleepTemperatureSpinBox.setValue(int(arr[11]))
            self.main.ui.standTemperatureSpinBox.setValue(int(arr[12]))
            self.main.ui.sleepTimeoutSpinBox.setValue(int(arr[13]))
            self.main.ui.offTimeoutSpinBox.setValue(int(arr[14]))
